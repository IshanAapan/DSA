// find the range of max sum from an subArray nearest to start
...
void range_maxSum_subArray_nearest_to_start(vector <int>v,int n,int k){
...
int main() {
    ...
    range_maxSum_subArray_nearest_to_start(v, n,k);
    return 0;
}
